...
# model = Word2Vec(brown_corpus, vector_size=200, window=10, min_count=10, epochs=400)
...
source_documents = ["answer-scripts/source.txt"]
...
for i, row in enumerate(similarities):
    print(f"Similarity scores for student_{i+1}:")
